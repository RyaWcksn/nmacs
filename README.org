...
** Colorscheme
   ...
   | org-persist-load-all | #[0 \300 \207 [dashboard-insert-startupify-lists] 1] | single-font-size | x-wm-set-size-hint | tramp-register-archive-autoload-file-name-handler | table--make-cell-map |
